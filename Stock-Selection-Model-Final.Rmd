...
```{r Multivariate Regression Time Series without Time, echo=T, warning=F}
df <- stock_data()
...
## Multivariate Regression with Trend, Time and Volume Interaction
```{r Multivariate Regression with Trend, Time and Volume Interaction, echo=T, warning=F}
df <- stock_data()
# First Variable has the "time shift"
ccf(df$volume,df$low, type="correlation") # nothing too significant to warrant lagging volume
ccf(df$HiLo,df$low, type="correlation") # no strong cross-correlation
...
## Multivariate Regression with Trend, Time and Volume Interaction, Time and OpClo Interaction
```{r Multivariate Regression with Trend, Time and Volume Interaction, Time and OpClo Interaction, echo=T, warning=F}
df <- stock_data()
# First Variable has the "time shift"
ccf(df$volume,df$low, type="correlation") # nothing too significant to warrant lagging volume
ccf(df$HiLo,df$low, type="correlation") # no strong cross-correlation
